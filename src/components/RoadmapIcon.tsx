    ...
    return (
            <div className="flex m-10">
                <div className="relative">
                    <Image alt={props.category} src={`/${props.category}.svg`} width={256} height={256} className={`${props.category.toLowerCase() == "react" ? "rounded-full" : "rounded-lg"} border-white border-8`} />
